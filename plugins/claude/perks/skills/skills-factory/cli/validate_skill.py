...
Engine module behind `skillfactory validate`. Shares description/frontmatter
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(prog="skillfactory validate", description=__doc__)
