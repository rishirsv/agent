...
Use `docs/spec.md` for normal top-level repo skills. Use `docs/<skill-name>-spec.md` only for nested meta-skill workbench projects or explicit overrides.
